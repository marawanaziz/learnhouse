...
# Birth & Baby University email branding. The remote PNG is used instead of an
# inline SVG because it renders more consistently across Gmail and Outlook.
BBU_LOGO_HTML = """
<img
    src="https://birthandbabyuniversity.com/wp-content/uploads/2024/03/birth-and-baby-logo-tm.png"
    width="230"
    alt="Birth &amp; Baby University"
    style="display: block; width: 230px; max-width: 100%; height: auto; margin: 0 auto;"
/>"""


# Shared BBU email styles
STYLES = {
    "body": "margin: 0; padding: 0; background-color: #ebf7ff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;",
    "wrapper": "padding: 48px 24px;",
    "container": "max-width: 480px; margin: 0 auto; background-color: #ffffff; border-radius: 18px; overflow: hidden; border: 1px solid #cfe3f1; border-top: 6px solid #6da0db;",
    "header": "padding: 42px 48px 0 48px; text-align: center;",
    "content": "padding: 36px 48px 48px 48px; text-align: center;",
    "h1": "margin: 0 0 12px 0; font-size: 24px; font-weight: 900; color: #113d5d; letter-spacing: -0.02em; line-height: 1.3;",
    "p": "margin: 0 0 20px 0; font-size: 14px; color: #6b6f79; font-weight: 500; line-height: 1.7;",
    "button": "display: inline-block; padding: 15px 34px; background-color: #113d5d; color: #ffffff; text-decoration: none; border-radius: 12px; font-size: 14px; font-weight: 700; line-height: 1;",
    "link_text": "margin: 24px 0 0 0; font-size: 11px; color: #7f96a6; word-break: break-all; font-weight: 500; line-height: 1.6;",
    "divider": "margin: 28px 0; border: none; border-top: 1px solid #dcecf5;",
    "footer": "padding: 0 48px 40px 48px; text-align: center;",
    "footer_text": "margin: 0; font-size: 12px; color: #7f96a6; font-weight: 500; line-height: 1.6;",
    "code": "display: inline-block; padding: 14px 28px; background-color: #ebf7ff; border: 1px solid #b9d5e7; border-radius: 12px; font-size: 28px; font-weight: 900; letter-spacing: 0.12em; color: #113d5d; font-family: monospace;",
}
