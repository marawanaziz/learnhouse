...
export default function ActivityNavigation(props: ActivityNavigationProps): React.ReactNode {
  ...
  return (
    <>
      ...
      {!isBottomNavVisible && (
        <div className="bbu-floating-lesson-navigation fixed bottom-8 left-1/2 transform -translate-x-1/2 z-sticky-header w-[85%] sm:w-auto sm:min-w-[350px] max-w-lg transition-all duration-300 ease-in-out">
          <div 
