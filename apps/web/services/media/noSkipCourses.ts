...
// Integrity (no-skip) course_uuid set — tested doula-certification courses whose
// videos disable forward-seek past the watched point. Fetched once per page load and
